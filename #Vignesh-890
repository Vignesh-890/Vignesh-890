...
<body>
    ...
    <header>
        ...
        <img src="/storage/emulated/0/Pictures/Remini/1743574459110.jpg" alt="Vignesh B" class="profile-picture">
    ...
    <section id="resume">
        <div class="section-content" style="text-align: center;">
            ...
            <a href="/storage/emulated/0/Download/Resume-3.pdf" class="download-button">Download CV</a>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="Vignesh B">cs2301111058256@lngovernmentcollege.com</a></p>
        </div>
    </section>
